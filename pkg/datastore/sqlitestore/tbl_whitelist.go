...
func encodeWhitelistMeta(meta *datastore.WhitelistMeta) ([]byte, error) {
...
func decodeWhitelistMeta(data []byte) (*datastore.WhitelistMeta, error) {
...
func (w *whitelist) FindByMD5(md5 string) (*datastore.WhitelistItem, error) {
	row := &datastore.WhitelistItem{}
...
func (s *whitelist) Insert(row datastore.WhitelistItem) error {
...
func (s *whitelist) InsertBatch(rows []datastore.WhitelistItem) (err error) {
	...
	insertBatch := func(batch []datastore.WhitelistItem, stmt *sqlx.Stmt) error {
